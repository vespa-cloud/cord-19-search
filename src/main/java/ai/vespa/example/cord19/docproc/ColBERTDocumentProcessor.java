...
package ai.vespa.example.cord19.docproc;
...
public class ColBERTDocumentProcessor extends DocumentProcessor {
            ...
            if (op instanceof DocumentPut) {
                ...
                if (text != null && text.getDataType() != DataType.STRING)
                    return DocumentProcessor.Progress.
                            FAILED.withReason(("Input field 'abstract' is not string field"));
    ...
    public Tensor getColBERTDocumentEmbeddings(StringFieldValue field)  {
        ...
        Tensor input_ids_batch = getTensorRepresentation(input_ids,"d1").
                multiply(BATCH_TENSOR);
        Tensor attention_mask_batch = getTensorRepresentation(attention_mask,"d1").
                multiply(BATCH_TENSOR);
    ...
    private static IndexedTensor getTensorRepresentation(List<Integer> tokens, String dimension)  {
